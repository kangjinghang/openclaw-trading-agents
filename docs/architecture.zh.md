...
- **第5层 rebalancer**（[`rebalancer-pipeline.zh.md`](rebalancer-pipeline.zh.md)）：ranker top-N + 用户持仓 → 调仓方案（BUY/SELL/ADD/REDUCE/HOLD），10 条硬约束（单仓/行业/换手/现金/anti-churn）+ revise loop + execution-planner
