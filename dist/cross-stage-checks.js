...
exports.crossStageChecks = crossStageChecks;
 ...
 */
function crossStageChecks(result, latestClose) {
    const issues = [];
    ...
    if (conservative?.verdict === "reject" &&
    ...
    if (result.final.risk_assessment === "reject" &&
...
//# sourceMappingURL=cross-stage-checks.js.map