 ...
 */
async function execPython(scriptPath, args = [], stdinData = null, pythonCmd = resolvePythonCmd(), timeoutMs = constants_1.PYTHON_SCRIPT_TIMEOUT_MS, useCache = true, cacheDir) {
    // Check cache first
